...
import './App.css'
import B12 from './components/three/models/B122'
...
const CameraController = () => {
    ...
    useFrame(state => {
        ...
        object.rotation.x = -state.mouse.y/1.2
        object.rotation.y = -state.mouse.x/1.2
...
export default function App() {
    ...
    return (
        <>
                ...
                <Canvas shadowMap shadows gl={{ antialias: false }}>
                    <CameraController/>
                    <color attach="background" args={['#ffffff']} />
                    {/*<fog attach="fog" args={['#000000', 0, 60]} />*/}
                    {/*<hemisphereLight intensity={.9} color="#eaeaea" groundColor="black" />*/}
                    <B12/>
                    <ambientLight intensity={0.1} />
                    <Box color="black" position={[-2, 2, 8]} />
                    <Text/>
                    <directionalLight intensity={9}  position={[10, 10, -10]} />
                    {/*<Effects >*/}
